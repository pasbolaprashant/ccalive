var app = angular.module('RejectedCompensationRequestModule', []);

app.service('RejectedCompensationRequestService', function ($http) {
    //getCOmplaintTYpe
    var ComplaintID = 0;
    var compobj = {};
    var formobj = {};
    ...
    this.GetPendingRequestForApproval = function (EmpCode) {
        ...
        return $http.get('/api/PendingRequest/GetRejectedCompensationRequest?EmpCode=' + EmpCode);
    };
...
app.controller('RejectedCompensationRequestController', function ($scope, $http, $location, $rootScope, RejectedCompensationRequestService, $q, $filter, $uibModal) {
    ...
    $scope.init = function () {
        ...
        RejectedCompensationRequestService.DealerDetails().then(function (success) {
        ...
        //get substrate id
        RejectedCompensationRequestService.GetSubstrateId().then(function (success) {
            console.log("inside GetComplaintCategory");
        ...
        //get product ID
        RejectedCompensationRequestService.GetProductId().then(function (success) {
        ...
        //GetComplaintCategory
        RejectedCompensationRequestService
    ...
    $scope.OpenStatus = function (id) {
        ...
        var modalInstance = $uibModal.open({
            ...
            controller: 'ModalInstanceCtrl_StatusRejectedCompensation',
            size: 'lg',
            resolve: {
                items: function () {
                    return id;
        ...
        RejectedCompensationRequestService.ComplaintID = id;
    ...
    $scope.GetPendingRequest = function (EmpCode) {
        RejectedCompensationRequestService.GetPendingRequestForApproval(EmpCode).then(function (success) {
    ...
    $scope.GetTSE = function () {
        RejectedCompensationRequestService.GetTSEList().then(function (success) {
    ...
    $scope.GetComplaintDetails = function (ComplaintId, status) {
        ...
        RejectedCompensationRequestService.GetComplaintDetails(ComplaintId).then(function (success) {
            ...
            RejectedCompensationRequestService.GetRequesterDetails($scope.ComplaintDtl.CustomerComplaint.CreatedBy).then(function (success) {
                $scope.Emp = success.data;
            }, function (error) {
                console.log(error);
            });

            RejectedCompensationRequestService.GetCompensationDetails(ComplaintId).then(function (success) {
            ...
            $scope.GetTSE();
            RejectedCompensationRequestService.GetComplaintHandlerDetails(ComplaintId, 4).then(function (success) {
            ...
            RejectedCompensationRequestService.GetComplaintHandlerDetails(ComplaintId, 2).then(function (success) {
                //$scope.TSE = success.data.Model;
        ...
        RejectedCompensationRequestService.GetCompensationStatusDetails(ComplaintId).then(function (success) {
            console.log("inside GetComplaintCategory");
    ...
    $scope.UploadSignedCompensationForm = function () {
        ...
        swal({
           ...
           function () {
               ...
               RejectedCompensationRequestService.uploadImage(fd).then(function (success) {
    ...
    $scope.BrandName = function () {
        ...
        RejectedCompensationRequestService.GetBrandName($scope.Complaint.BrandID).then(function (success) {
        ...
        RejectedCompensationRequestService.GetBatchAndMfg($scope.Complaint.ProductCode).then(function (success) {
    ...
    $scope.GetComplaintList = function (obj) {
        ...
        RejectedCompensationRequestService.GetComplaintList(obj.ComplaintCategory_ID).then(function (success) {
    ...
    $scope.CreateCompesnation = function () {
        ...
        swal({
            ...
            function () {
                ...
                RejectedCompensationRequestService.CreateComp($scope.FormDetails).then(function (success) {
                    console.log("SUCCESS DATA", success.data);
                    swal(success.data);
                    $scope.init();
                },
...
app.controller('ModalInstanceCtrl_StatusRejectedCompensation', function ($scope, $uibModalInstance, RejectedCompensationRequestService, $q) {
    $scope.PendingStatusData = {};
    $scope.grid = {};
    $scope.initStatus = function () {
        RejectedCompensationRequestService.GetCompensationStatusDetails(RejectedCompensationRequestService.ComplaintID).then(function (success) {
            console.log("inside GetComplaintCategory");
            $scope.PendingStatusData = success.data;
            console.log($scope.DealerDetails);
        },
...
app.controller('ModalInstanceCtrl_PrintPopupPendingCompensation', function ($scope, $uibModalInstance, RejectedCompensationRequestService, $q) {
    $scope.PendingStatusData = {};
    $scope.grid = {};
    $scope.initStatus = function () {
        RejectedCompensationRequestService.DealerDetails().then(function (success) {
        ...
        $scope.Emp = RejectedCompensationRequestService.compobj;
        $scope.FormDetails = RejectedCompensationRequestService.formobj;
        $scope.CompForm = RejectedCompensationRequestService.employeeobj;
