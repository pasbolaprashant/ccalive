var app = angular.module('ApprovedCompensationRequestModule', []);

app.service('ApprovedCompensationRequestService', function ($http) {
    //getCOmplaintTYpe
    var ComplaintID = 0;
    var compobj = {};
    var formobj = {};
    ...
    this.GetPendingRequestForApproval = function (EmpCode) {
        ...
        return $http.get('/api/PendingRequest/GetApprovedCompensationRequest?EmpCode=' + EmpCode);
    };
...
app.controller('ApprovedCompensationRequestController', function ($scope, $http, $location, $rootScope, ApprovedCompensationRequestService, $q, $filter, $uibModal) {
    ...
    $scope.SettlementModesREPProductCode = "";
    $scope.SettlementModesFOCProductCode = "";
    ...
    $scope.init = function () {
        ...
        ApprovedCompensationRequestService.DealerDetails().then(function (success) {
        ...
        //get substrate id
        ApprovedCompensationRequestService.GetSubstrateId().then(function (success) {
            console.log("inside GetComplaintCategory");
        ...
        //get product ID
        ApprovedCompensationRequestService.GetProductId().then(function (success) {
        ...
        //GetComplaintCategory
        ApprovedCompensationRequestService
    ...
    $scope.OpenStatus = function (id) {
        ...
        ApprovedCompensationRequestService.ComplaintID = id;
    ...
    $scope.GetPendingRequest = function (EmpCode) {
        ApprovedCompensationRequestService.GetPendingRequestForApproval(EmpCode).then(function (success) {
    ...
    $scope.GetTSE = function () {
        ApprovedCompensationRequestService.GetTSEList().then(function (success) {
    ...
    $scope.GetComplaintDetails = function (ComplaintId, status) {
        ...
        ApprovedCompensationRequestService.GetComplaintDetails(ComplaintId).then(function (success) {
            ...
            ApprovedCompensationRequestService.GetRequesterDetails($scope.ComplaintDtl.CustomerComplaint.CreatedBy).then(function (success) {
                $scope.Emp = success.data;
            }, function (error) {
                console.log(error);
            });

            ApprovedCompensationRequestService.GetCompensationDetails(ComplaintId).then(function (success) {
                $scope.FormDetails = success.data;
              

                angular.forEach($scope.ProductMaster, function (value, key) {

                    if (value.Product_ID == $scope.FormDetails.SettlementModes[0].ReplacementProduct_ID)
                    {
                        $scope.SettlementModesREPProductCode = value.ProductCode;
                    }

                    if (value.Product_ID == $scope.FormDetails.SettlementModes[0].FOCProduct_ID) {
                        $scope.SettlementModesFOCProductCode = value.ProductCode;
                    }
                   });
            ...
            $scope.GetTSE();
            ApprovedCompensationRequestService.GetComplaintHandlerDetails(ComplaintId, 4).then(function (success) {
            ...
            ApprovedCompensationRequestService.GetComplaintHandlerDetails(ComplaintId, 2).then(function (success) {
                //$scope.TSE = success.data.Model;
        ...
        ApprovedCompensationRequestService.GetCompensationStatusDetails(ComplaintId).then(function (success) {
            console.log("inside GetComplaintCategory");
    ...
    $scope.UploadSignedCompensationForm = function () {
        ...
        swal({
           ...
           function () {
               ...
               ApprovedCompensationRequestService.uploadImage(fd).then(function (success) {
    ...
    $scope.BrandName = function () {
        ...
        ApprovedCompensationRequestService.GetBrandName($scope.Complaint.BrandID).then(function (success) {
        ...
        angular.forEach($scope.ProductMaster, function (value, key) {
            ...
            //console.log("fullbakchodi mtype of data", $scope.FormDetails.SettlementModes);
            ////if (value.Product_ID == $scope.FormDetails.SettlementModes.ReplacementProduct_ID) {

            //    $scope.Complaint.BrandID = value.Brand_ID;
            //    $scope.SettlementModes.ProductCode = value.ProductCode;
        ...
        ApprovedCompensationRequestService.GetBatchAndMfg($scope.Complaint.ProductCode).then(function (success) {
    ...
    $scope.GetComplaintList = function (obj) {
        ...
        ApprovedCompensationRequestService.GetComplaintList(obj.ComplaintCategory_ID).then(function (success) {
    ...
    $scope.CreateCompesnation = function () {
        ...
        swal({
            ...
            function () {
                ...
                ApprovedCompensationRequestService.CreateComp($scope.FormDetails).then(function (success) {
                    console.log("SUCCESS DATA", success.data);
                    swal(success.data);
                    $scope.init();
                },
...
app.controller('ModalInstanceCtrl_StatusApprovedCompensation', function ($scope, $uibModalInstance, ApprovedCompensationRequestService, $q) {
    $scope.PendingStatusData = {};
    $scope.grid = {};
    $scope.initStatus = function () {
        ApprovedCompensationRequestService.GetCompensationStatusDetails(ApprovedCompensationRequestService.ComplaintID).then(function (success) {
            console.log("inside GetComplaintCategory");
            $scope.PendingStatusData = success.data;
            console.log($scope.DealerDetails);
        },
...
app.controller('ModalInstanceCtrl_PrintPopupPendingCompensation', function ($scope, $uibModalInstance, ApprovedCompensationRequestService, $q) {
    $scope.PendingStatusData = {};
    $scope.grid = {};
    $scope.initStatus = function () {
        ApprovedCompensationRequestService.DealerDetails().then(function (success) {
        ...
        $scope.Emp = ApprovedCompensationRequestService.compobj;
        $scope.FormDetails = ApprovedCompensationRequestService.formobj;
        $scope.CompForm = ApprovedCompensationRequestService.employeeobj;
