var app = angular.module('RequesterUserModule', []);

app.service('RequesterUserService', function ($http) {
...
app.controller('RequesterUserController', function ($scope, $http, $location, $rootScope, HomeService, RequesterUserService, $uibModal, $q, $filter){
    ...
    $scope.init = function () {
        ...
        var ComplaintId = HomeService.ReqIds.Cpmplaint_Id;
        var ComplaintNumber = HomeService.ReqIds.ComplaintNumber;

        console.log("service  ComplaintId:", ComplaintId)
            console.log("service complaint no:", ComplaintNumber);



            RequesterUserService.DealerDetails().then(function (success) {

                $scope.DealerDetails = success.data;
                console.log("DealerDetails", $scope.DealerDetails);

                return RequesterUserService.GetComplaintDetails(ComplaintId);
            ...
            //RequesterUserService.GetComplaintDetails(ComplaintId).then(function (success) {
        ...
        //get substrate id
        RequesterUserService.GetSubstrateId().then(function (success) {
            console.log("inside GetComplaintCategory");
        ...
        //get product ID
        RequesterUserService.GetProductId().then(function (success) {
        ...
        //GetComplaintCategory
        RequesterUserService.GetComplaintCategory().then(function (success) {
            console.log("inside GetComplaintCategory");
    ...
    $scope.getDel = function (id) {
        ...
        RequesterUserService.GetdealerHander(id).then(function (success) {
            console.log("inside GetComplaintCategory");
    ...
    $scope.uploadImage = function () {
        ...
        console.log("Substrate:----", $scope.subInfo.Substrate);

        console.log("SubstrateRelated:----", $scope.subInfo.SubstrateRelated);
        ...
        var obj = {
            ...
            BatchNumber1: $scope.BatchNumber1,
            ...
            Tempreature: $scope.Complaint.Tempreature,
            Humidity: $scope.Complaint.Humidity,
        ...
        swal({
            ...
            function (isConfirm) {
                if (isConfirm) {
                    ...
                    RequesterUserService.ReSubmitRequest(fd).then(function (success) {
    ...
    $scope.GetComplaintList = function (obj) {
        ...
        RequesterUserService.GetComplaintList(obj.ComplaintCategory_ID).then(function (success) {
    ...
    $scope.SaveData = function (Request, Complaint) {
        ...
        RequesterUserService.GetData(obj).then(function (success) {
    ...
    $scope.BrandName = function () {
        ...
        RequesterUserService.GetBrandName($scope.Complaint.BrandID).then(function (success) {
        ...
        RequesterUserService.GetBatchAndMfg($scope.Complaint.ProductCode).then(function (success) {
    ...
    $scope.SystemInformation = function (Underbody, Undercoat, Basecoat, Clearcoat, Thinner) {
        ...
        RequesterUserService.SystemInformation($scope.SystemInfo).then(function (success) {
    ...
    //    //} 
    //    console.log(ReqDtl);
    //    RequesterUserService.CreateRequest(ReqDtl).then(function (success) {
    //        console.log("Api hit");
    ...
    //    }
    //    console.log(data);
    //    RequesterUserService.removeApproval(data).then(function success(data) {
    //        console.log(data);
    //        swal(data.data);
    //    }, function error(data)
    //        { console.log(data); });
    ...
    //        SBU_Name: dp,
    //    };
    //    RequesterUserService.GetDept(item).success(function (data) {
    ...
    //    };
    //    console.log(data)
    //    RequesterUserService.GetDeptSegment(item).success(function (data) {
    ...
    //    };
    //    console.log(data)
    //    RequesterUserService.GetZoneNameBySegment(item).success(function (data) {
    ...
    //        RequesterUserService.SaveApproval($scope.SaveArray).then(function success(data) {
    //            console.log(data);
    //            swal(data.data);
    //            $scope.init();
    //        }, function error(data) {
