...
app.service('RejectedRequestService', function ($http) {
    //getCOmplaintTYpe
    ...
    this.GetPendingRequestForApproval = function (EmpCode) {
        ...
        return $http.get('/api/PendingRequest/GetUserRejectedRequest?EmpCode=' + EmpCode);
    };
...
app.controller('RejectedRequestController', function ($scope, $http, $location, $rootScope, RejectedRequestService, $uibModal, $q, $filter) {
    ...
    $scope.init = function () {
        ...
        RejectedRequestService.DealerDetails().then(function (success) {
        ...
        //get substrate id
        RejectedRequestService.GetSubstrateId().then(function (success) {
            console.log("inside GetComplaintCategory");
        ...
        //get product ID
        RejectedRequestService.GetProductId().then(function (success) {
    ...
    $scope.GetPendingRequest = function (EmpCode) {
        RejectedRequestService.GetPendingRequestForApproval(EmpCode).then(function (success) {
    ...
    $scope.GetTSE = function () {
        RejectedRequestService.GetTSEList().then(function (success) {
    ...
    $scope.GetComplaintDetails = function (ComplaintId, status) {
        RejectedRequestService.GetComplaintEmployee(ComplaintId).then(function (success) {
            $scope.EmployeeDetails = success.data;
        }, function (error) {
            console.log(error);
        });
        RejectedRequestService.GetComplaintDetails(ComplaintId).then(function (success) {
        ...
        RejectedRequestService.GetStatusDetails(ComplaintId).then(function (success) {
            console.log("inside GetComplaintCategory");
    ...
    $scope.OpenStatus = function (id) {
        ...
        var modalInstance = $uibModal.open({
            ...
            controller: 'ModalInstanceCtrl_StatusRejected',
            size: 'lg',
            resolve: {
                items: function () {
                    return id;
        ...
        RejectedRequestService.ComplaintID = id;
    ...
    $scope.BrandName = function () {
        ...
        RejectedRequestService.GetBrandName($scope.Complaint.BrandID).then(function (success) {
        ...
        RejectedRequestService.GetBatchAndMfg($scope.Complaint.ProductCode).then(function (success) {
    ...
    $scope.GetComplaintList = function (obj) {
        ...
        RejectedRequestService.GetComplaintList(obj.ComplaintCategory_ID).then(function (success) {
...
app.controller('ModalInstanceCtrl_StatusRejected', function ($scope, $uibModalInstance, RejectedRequestService, $q) {
    $scope.PendingStatusData = {};
    $scope.grid = {};
    $scope.initStatus = function () {
        RejectedRequestService.GetStatusDetails(RejectedRequestService.ComplaintID).then(function (success) {
            console.log("inside GetComplaintCategory");
            $scope.PendingStatusData = success.data;
            console.log($scope.DealerDetails);
        },
